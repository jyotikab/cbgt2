...
def helper_poppathways(popdata, newpathways=None):
    ...
    simplepathways = pd.DataFrame(
        [
            ['LIP', 'D1STR', 'AMPA', 'syn', 0.45, 0.027 * dpmn_ratio / dpmn_implied, True],
            #['LIP', 'D1STR', 'AMPA', 'syn', 1.0, 0.027 * dpmn_ratio / dpmn_implied, True],
            ['LIP', 'D1STR', 'NMDA', 'syn', 0.45, 0.027 * (1 - dpmn_ratio), False],
            #['LIP', 'D1STR', 'NMDA', 'syn', 1.0, 0.027 * (1 - dpmn_ratio), False],
            ['LIP', 'D2STR', 'AMPA', 'syn', 0.45, 0.027 * dpmn_ratio / dpmn_implied, True],
            #['LIP', 'D2STR', 'AMPA', 'syn', 1.0, 0.027 * dpmn_ratio / dpmn_implied, True],
            ['LIP', 'D2STR', 'NMDA', 'syn', 0.45, 0.027 * (1 - dpmn_ratio), False],
            #['LIP', 'D2STR', 'NMDA', 'syn', 1.0, 0.027 * (1 - dpmn_ratio), False],
            ['LIP', 'FSI', 'AMPA', 'all', 0.45, 0.198, False],
            #['LIP', 'FSI', 'AMPA', 'all', 1.0, 0.198, False],
            ['LIP', 'Th', 'AMPA', 'all', 0.35, 0.035, False],
            #['LIP', 'Th', 'AMPA', 'all', 1.0, 0.035, False],
            ['LIP', 'Th', 'NMDA', 'all', 0.35, 0.035, False],
            #['LIP', 'Th', 'NMDA', 'all', 1.0, 0.035, False],
